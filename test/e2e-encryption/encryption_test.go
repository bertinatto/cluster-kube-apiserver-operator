...
func TestEncryptionTypeIdentity(t *testing.T) {
	library.TestEncryptionTypeIdentity(context.Background(), t, library.BasicScenario{
...
func TestEncryptionTypeUnset(t *testing.T) {
	library.TestEncryptionTypeUnset(context.Background(), t, library.BasicScenario{
		Namespace:                       operatorclient.GlobalMachineSpecifiedConfigNamespace,
		LabelSelector:                   "encryption.apiserver.operator.openshift.io/component" + "=" + operatorclient.TargetNamespace,
		EncryptionConfigSecretName:      fmt.Sprintf("encryption-config-%s", operatorclient.TargetNamespace),
		EncryptionConfigSecretNamespace: operatorclient.GlobalMachineSpecifiedConfigNamespace,
...
func TestEncryptionTurnOnAndOff(t *testing.T) {
	library.TestEncryptionTurnOnAndOff(context.Background(), t, library.OnOffScenario{
